...
('Plano Gold', 195.00), 
('Plano Fitness', 135.00), 
('Plano Básico', 85.00);

INSERT INTO modalidades (plano_id, nome, sala, capacidade_maxima, disponivel) VALUES 
(1, 'Treino Funcional', 'Sala 01', 20, TRUE),
(2, 'Pilates', 'Sala 02', 12, TRUE),
(3, 'Musculação', 'Sala Principal', 45, TRUE);

INSERT INTO alunos (nome, email, cpf, telefone) VALUES 
('Sofia Martins', 'sofia@email.com', '12345678901', '48999990000'),
('Lucas Oliveira', 'lucas@email.com', '23456789012', '48988880000'),
('Mariana Santos', 'mariana@email.com', '34567890123', '48977770000');
